...
export default function ResultsSearch(){
    ...
    return (
        <div className={"flex items-center border border-dashed bg-stone-50 p-2 rounded-lg justify-between gap-4"}>
            <div className={"flex gap-3"}>
                <div className={"flex flex-col gap-2"}>
                    ...
                    <div className={"flex gap-2"}>
                        <input
                            className={"p-2 text-gray-500 text-xs font-medium border rounded-lg focus:ring-2 ring-indigo-500 outline-0"}
            ...
            <div className={"flex flex-col gap-2 w-full"}>
                ...
                <select className={"p-2 cursor-pointer border text-gray-600 hover:text-gray-500 text-sm font-medium rounded-lg"}>
