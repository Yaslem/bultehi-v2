...
import Results, { Header } from "../components/Results";

export default function Elementary({resultsProps}){
    return (
        <section className={"flex flex-col mb-4 gap-y-12"}>
            <div className={"border-4 self-center rounded-lg border-dashed w-28"} />
            {
                ...
                <>
                    <Results link={"/elementary/results"} title={process.env.TITLE_ELEMENTARY} resultsProps={resultsProps}/>
                    <div className={"border-4 self-center rounded-lg border-dashed w-28"}/>
                </>
            }
                ...
                <div className={"grid grid-cols-4 gap-4"}>
                    <div className={"flex flex-col gap-4 border rounded-lg p-2"}>
                        <div className={"flex gap-4"}>
                            <Image className={"w-10 h-10 rounded-full object-cover"} width={40} height={40} src={"/files/images/1.jpg"} alt={""}/>
                        ...
                        <Image className={"w-full self-center h-52 object-cover rounded-lg"} width={100} height={100} src={"/files/images/2.jpg"} alt={""}/>
            ...
            <div className={"flex flex-col px-4 gap-4"}>
                ...
                <div className={"grid grid-cols-5 gap-4"}>
                    <div className={"bg-white rounded-lg border p-2 flex flex-col gap-4"}>
                        <Image className={"w-fit self-center h-60 rounded-lg"} width={100} height={100} src={"/files/images/5.jpg"} alt={""}/>
